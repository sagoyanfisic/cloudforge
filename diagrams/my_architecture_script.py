...
with Diagram("Production-Grade E-commerce Monolith on AWS Fargate", show=False, filename='/app/diagrams/my_architecture', direction="TB", graph_attr={"bgcolor": "#E74C3C10"}):
    ...
    s3_media_storage = S3("S3 Media Storage")

    # ── Container Registry ───────────────────────────────────────────────────
    ecr = ECR("ECR Container Registry")
